...
import { DecorationRenderOptions, Disposable, env, Event, EventEmitter, ExtensionContext, OverviewRulerLane, TextDocument, TextDocumentChangeEvent, TextEditor, TextEditorDecorationType, TextEditorViewColumnChangeEvent, window, workspace } from 'vscode';
                ...
                Decorations.highlight = window.createTextEditorDecorationType({
                    ...
                    dark: {
                        backgroundColor: cfgHighlight.locations.includes(BlameLineHighlightLocations.Line)
                            ...
                            : undefined,
                        gutterIconPath: cfgHighlight.locations.includes(BlameLineHighlightLocations.Gutter) && env.appName !== 'Sourcegraph'
